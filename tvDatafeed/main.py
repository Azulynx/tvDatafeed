...
class TvDatafeed:
    ...
    __search_url = 'https://symbol-search.tradingview.com/symbol_search/v3/?text={}&hl=1&exchange={}&lang=en&type=&domain=production'
    ...
    def search_symbol(self, symbol: str, type: str = '', exchange: str = ''):
        """
